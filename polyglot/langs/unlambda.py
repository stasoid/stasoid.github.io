# Author: bwo (https://github.com/bwo/unlambda/blob/master/runlambda.py)
# Note from @potato44: This is an Unlambda interpreter that ignores characters it doesn't recognise, unlike the one on TIO
